...
(ert-deftest robby--curl-parse-response--streaming-response ()
  (let ((parsed (robby--curl-parse-response 'chat (robby--read-file-into-string "./fixtures/streaming-response-complete.txt") "" t)))
...
(ert-deftest robby--curl-parse-response--streaming-response-incomplete () ;
  (let ((part1 (robby--curl-parse-response 'chat (robby--read-file-into-string "./fixtures/streaming-response-incomplete-part-1.txt") "" t)))
